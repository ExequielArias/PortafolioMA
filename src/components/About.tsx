export { AcercaDe as About } from "../componentes/AcercaDe";
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          >
            <motion.p className="text-slate-600" variants={itemVariants}>
              Soy Matías Exequiel Arias Carrasco, un apasionado analista de sistemas y desarrollador de software de 21 años, comprometido con la creación de soluciones tecnológicas innovadoras y eficientes.
            </motion.p>
